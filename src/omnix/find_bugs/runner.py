...
def _run_find_bugs_core(
    ...
    *,
    ...
    from omnix.graph.store import GraphStore
    from omnix.parser import evolution as _evo
    from omnix.parser.ingest_dispatch import run_evolution_ingest_on_store
    ...
    if turboscan and incremental:
        from omnix.scan.turboscan.incremental import filter_incremental_paths
    ...
    if turboscan:
        ...
        from omnix.scan.turboscan.orchestrator import dispatch_turboscan_python_phase
    ...
    if (
        ...
        from omnix.verify.runners import cargo_fuzz as _cargo
        from omnix.verify.runners import go_fuzz as _gof
        from omnix.verify.runners import jqwik as _jqw
        from omnix.verify.runners.detect import detect_universal_backend
        from omnix.verify.runners.subprocess_llm import run_layer6_subprocess_limited
    ...
    if turboscan and not plan_only:
        try:
            from omnix.scan.turboscan.incremental import write_last_green_scan
