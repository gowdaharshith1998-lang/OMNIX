...
export const CANONICAL_SCOPES: ScopeRecord[] = [
  ...
  },
  {
    ...
    label: "AXIOM-V2",
    badge: "MODULE",
    pathPrefix: "apps/backend/src/omnix/axiom",
  },
  {
    id: "crypto",
    parentId: "av2",
    label: "crypto",
    badge: "MODULE",
    pathPrefix: "apps/backend/src/omnix/axiom/services/crypto",
  },
  {
    id: "hyb",
    parentId: "crypto",
    ...
    badge: "FILE",
    pathPrefix: "apps/backend/src/omnix/axiom/services/crypto/hybrid_signer.py",
  },
];
