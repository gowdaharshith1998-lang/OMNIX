...
from axiom import sign as mldsa_sign
from axiom import verify as mldsa_verify
from axiom.finding_keys import project_privkey_path, sign_finding, verify_finding
...
from axiom.merkle import compute_leaf_hash, compute_merkle_root
...
def find_bugs_tool_version() -> str:
    ...
    try:
        ...
        pass
    from omnix_version import __version__
...
def emit_scan_receipts(
    ...
    *,
    ...
    from omnix_version import __version__ as ov
