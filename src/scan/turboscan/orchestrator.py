...
from scan.turboscan.budget_planner import build_budget_plan
from scan.turboscan.database import worker_hypothesis_dir
from scan.turboscan.hygiene_inotify import start_hygiene_watcher
from scan.turboscan.types import BudgetPlan, TurboScanResult, raw_findings_to_views
from scan.turboscan.worker_pool import map_verify_tasks, map_verify_tasks_serial
...
def dispatch_turboscan_python_phase(
    *,
    ...
    """
    from find_bugs.entry_points import detect_framework_decorated, graph_id_for
    from find_bugs.runner import _apply_one_verify_outcome, _relpos, _skip_for_main_transparency
